      ...
      <form name="form-data" action="recibCliente.php" method="POST" class="needs-validation" novalidate>
        ...
        <div class="modal-body">
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-6">
              <label class="form-label">
                <i class="fas fa-calendar-day me-2"></i>Día de Emisión
              </label>
          ...
          <div class="mb-3">
            <label class="form-label">
              <i class="fas fa-music me-2"></i>Canciones del Anime</label>
            <div class="d-flex gap-4">
              <div class="form-check">
                <input type="checkbox" class="form-check-input" id="checkOP" name="OP" value="SI">
                <label class="form-check-label" for="checkOP">Opening (OP)</label>
              </div>
              <div class="form-check">
                <input type="checkbox" class="form-check-input" id="checkED" name="ED" value="SI">
                <label class="form-check-label" for="checkED">Ending (ED)</label>
              </div>
            </div>
          </div>
        </div>
