    ...
    <div class="modal-content">
      ...
      <form method="POST" action="recib_Update-ED.php">
        ...
        <div class="modal-body" id="cont_modal">
          ...
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">N° Ending:</label>
            <input type="number" name="ed" class="form-control" min="<?php echo $mostrar['Ending']; ?>" value="<?php echo $mostrar['Ending']; ?>">
          </div>
          ...
          <div class="form-group">
            ...
            <select name="estado" class="form-control">
              ...
              <?php
              $query = $conexion->query("SELECT * FROM `estado_ed`;");
              while ($valores = mysqli_fetch_array($query)) {
          ...
          <div class="form-group">
            ...
            <select name="mix" class="form-control">
              <option value="<?php echo $mostrar['Mix']; ?>">Seleccione:</option>
              <?php
              $query = $conexion->query("SELECT * FROM `mix_ed`;");
              while ($valores = mysqli_fetch_array($query)) {
