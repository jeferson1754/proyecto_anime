...
<body>
    ...
    <div class="main-container">
        ...
        if (isset($_GET['enviar'])) {
            ...
            $where = "WHERE emision.Descargados > emision.No_Descargados AND anime.Estado='Emision' AND emision.ID > 1 ORDER BY (emision.Descargados - emision.No_Descargados) ASC;";
        }
                    ...
                    <tbody>
                        ...
                        while ($mostrar = mysqli_fetch_array($result)) {
                            ...
                            if ($mostrar['Totales'] > 0) {
                                $faltantes = $mostrar['Descargados'] - $mostrar['No_Descargados'];
                                $porcentaje = ($mostrar['No_Descargados'] / $mostrar['Totales']) * 100;
                            } else {
                                $faltantes = $mostrar['Descargados'] - $mostrar['No_Descargados'];
                                $porcentaje = 0;
                            }
                        ?>
                            <tr>
                                <td class="fw-500">
                                    ...
                                    <?php if ($tieneOpening < 1 && $mostrar['No_Descargados'] < 3): ?>
                                ...
                                <td>
                                    <div class="progress-cell">
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <span class="small"><?php echo $mostrar['No_Descargados'] ?>/<?php echo $mostrar['Totales'] ?></span>
                                        </div>
                                    </div>
