...
<body>
    ...
    <div class="main-container">
        ...
        <table id="example" style="width:100%">
            ...
            $sql = "  SELECT op.ID,op.Nombre,op.ID_Anime,op.Opening,op.Cancion,op.Ano,temporada.Temporada,op.Estado,op.Link,op.Mix,op.Estado_Link,op.mostrar FROM `op`  JOIN temporada ON   op.Temporada=temporada.ID $where";
            //echo $sql;
