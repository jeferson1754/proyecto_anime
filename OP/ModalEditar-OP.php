...
<div class="modal fade" id="editpeli3<?php echo $mostrar['ID']; ?>"
  tabindex="-1"
  role="dialog"
    ...
    <div class="modal-content">
      ...
      <div class="modal-header bg-light">
        <h5 class="modal-title" id="animeUpdateModal">
          <i class="fas fa-edit me-2"></i>Actualizar Información del Opening
        </h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>

      <form method="POST" action="recib_Update-OP.php" class="needs-validation" id="Edicion_OP<?php echo $mostrar['ID']; ?>" novalidate>
        <!-- Hidden Fields -->
            ...
            <div class="row mb-4">
              <div class="col-12">
                <div class="card bg-light">
                  <div class="card-body">
                    <h4 class="text-primary text-center mb-0"><?php echo $mostrar['Nombre'] . "  OP " . $mostrar['Opening'] ?></h4>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="col-md-6">
                <div class="form-floating mb-3">
                  <select id="estado" name="estado" class="form-control">
                    ...
                    $query = $conexion->query("SELECT * FROM `estado_op` WHERE Nombre != '$estado_actual'");
              ...
              <div class="col-md-6">
                <div class="form-floating mb-3">
                  <select id="mix" name="mix" class="form-control">
                    ...
                    $query = $conexion->query("SELECT * FROM `mix` WHERE ID != '$mix_actual'");
