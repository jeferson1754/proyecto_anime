...
<head>
    ...
    <title>Openings Dashboard</title>
    <!-- CSS -->
    ...
    <div class="main-container">
        ...
        <div class="actions-panel button-group">
            ...
            <div id="animeFilter" class="search-filter">
                <form action="" method="GET" class="row g-3">
                    <div class="col-md-4">
                        <input type="text" name="busqueda_op" class="form-control" value="<?= htmlspecialchars($_GET['busqueda_op'] ?? '', ENT_QUOTES) ?>" placeholder="Nombre del Anime">
                    </div>
                    <div class="col-md-4">
            ...
            <div id="songFilter" class="search-filter">
                <form action="" method="GET" class="row g-3">
                    <div class="col-md-4">
                        <input type="text" name="busqueda_cancion" class="form-control w-64" value="<?= htmlspecialchars($_GET['busqueda_cancion'] ?? '', ENT_QUOTES) ?>" placeholder="Nombre de la Cancion">
                    </div>
                    <div class="col-md-4">
            ...
            <div class="table-container table-responsive">
                <table id="animeTable" class="table custom-table">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT op.ID,CONCAT(anime.Nombre, ' ',op.Temporada) as Nombre, anime.Nombre as album, op.ID_Anime,op.Opening,op.Cancion,autor.Autor,autor.Copia_Autor,op.Ano,op.Temporada_Emision as Temporada,op.Estado,op.Link,op.Link_Iframe,op.Mix,op.Estado_Link FROM `op` JOIN autor ON op.ID_Autor=autor.ID JOIN anime ON op.ID_Anime=anime.id $where";
                        //echo $sql;
